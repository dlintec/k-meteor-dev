...
RUN apt-get update && \
apt-get install -y curl git python2.7 python2.7-dev build-essential whiptail vim nano nginx lsof imagemagick mongodb-org language-pack-en net-tools iproute2 
#ufw
...
RUN bash source /home/meteor/localimage/.nvm/nvm.sh
